create transient schema if not exists schema1 data_retention_time_in_days=0;  create or replace table schema1.table1 as select
   ...
   ,column12::boolean as column12
   ,column13::integer as column13
   ,(case when uniform(1,1000,random(20014)) > 300 then column101 else null end)::date as column101
   ,(case when uniform(1,1000,random(20015)) > 300 then column102 else null end)::timestamp as column102
   ,(case when uniform(1,1000,random(20016)) > 300 then column103 else null end)::varchar(10) as column103
   ,(case when uniform(1,1000,random(20017)) > 300 then column104 else null end)::char(10) as column104
   ,(case when uniform(1,1000,random(20018)) > 300 then column105 else null end)::bigint as column105
   ,(case when uniform(1,1000,random(20019)) > 300 then column106 else null end)::integer as column106
   ,(case when uniform(1,1000,random(20020)) > 300 then column107 else null end)::double as column107
   ,(case when uniform(1,1000,random(20021)) > 300 then column108 else null end)::float as column108
   ,(case when uniform(1,1000,random(20022)) > 300 then column109 else null end)::number(10,2) as column109
   ,(case when uniform(1,1000,random(20023)) > 300 then column110 else null end)::char(10) as column110
   ,(case when uniform(1,1000,random(20024)) > 300 then column111 else null end)::bigint as column111
   ,(case when uniform(1,1000,random(20025)) > 300 then column112 else null end)::boolean as column112
   ,(case when uniform(1,1000,random(20026)) > 300 then column113 else null end)::integer as column113
from ( 
   select
